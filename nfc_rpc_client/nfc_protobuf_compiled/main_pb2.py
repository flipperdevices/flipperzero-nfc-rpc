...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _COMMANDSTATUS._serialized_start = 396
    _COMMANDSTATUS._serialized_end = 1122
    _EMPTY._serialized_start = 51
    _EMPTY._serialized_end = 58
    _MAIN._serialized_start = 61
    _MAIN._serialized_end = 393